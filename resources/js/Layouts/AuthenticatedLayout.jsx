...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const navigationItems = [
        ...
        },
        {
            name: 'Patients',
            href: '/patients',
            active: currentUrl.startsWith('/patients'),
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            name: 'Eye Theatre',
            href: '/surgeries',
            active: currentUrl.startsWith('/surgeries'),
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            name: 'Pharmacy',
            href: '/pharmacy',
            active: currentUrl.startsWith('/pharmacy'),
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 011 1v1a1 1 0 01-1 1v9a2 2 0 01-2 2H8a2 2 0 01-2-2V7a1 1 0 01-1-1V5a1 1 0 011-1h4zM9 3v1h2V3H9zm0 3v10h2V6H9z" />
                </svg>
            )
        },
        {
        ...
        },
        {
            name: 'Billing',
            href: '/invoices',
            active: currentUrl.startsWith('/invoices'),
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            <nav className="bg-white/95 backdrop-blur-sm shadow-lg border-b border-blue-100">
